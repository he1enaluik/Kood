          ...
          <div class="contact-page__info">
            ...
            <div class="contact-page__social">
              <a href="#" class="contact-page__social-link" aria-label="TikTok">
                <img src="{{ asset('Ikoonid/tiktok.svg') }}" alt="" width="27" height="27">
              </a>
              <a href="#" class="contact-page__social-link" aria-label="Instagram">
                <img src="{{ asset('Ikoonid/instagram.svg') }}" alt="" width="27" height="27">
              </a>
              <a href="#" class="contact-page__social-link" aria-label="Facebook">
                <img src="{{ asset('Ikoonid/facebook.svg') }}" alt="" width="27" height="27">
              </a>
            </div>
          </div>
          ...
          <form class="contact-page__form" action="#" method="post">
            <div class="contact-page__form-row">
              <label class="contact-page__field">
                ...
                <input class="contact-page__input" type="text" name="firstname" autocomplete="given-name">
              </label>
              <label class="contact-page__field">
                <span class="contact-page__label">Perekonnanimi</span>
                <input class="contact-page__input" type="text" name="lastname" autocomplete="family-name">
              </label>
            </div>
            ...
            <label class="contact-page__field">
              ...
              <textarea class="contact-page__input contact-page__textarea" name="message" required></textarea>
            </label>
